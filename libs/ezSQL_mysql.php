<?php
	...
	*/
	...
	if ( ! class_exists ('ezSQLcore') ) die('<b>Fatal Error:</b> ezSQL_mysql requires ezSQLcore (ezSQLcore.php) to be included/loaded before it can be used');

	class ezSQL_mysql extends ezSQLcore
	{

		var $dbuser = 'pereobui';
		var $dbpassword = 'pereobui';
		var $dbname = 'pereobui';
		...
		*/
		...
		function ezSQL_mysql($dbuser='root', $dbpassword='1Universal123', $dbname='pereobui', $dbhost='localhost', $encoding='utf8')
		{
			$this->dbuser = $dbuser;
		...
		*/
		...
		function connect($dbuser='pereobui', $dbpassword='pereobui', $dbhost='localhost')
		{
